...
<details>
	...
	<ul>
		...
		<li>
			The chasers will share their location with one member from each team (whoever has an iPhone).
		</li>
		...
		<li>
			During the first 15 and the last 15 minutes of the game, there is a moratorium on chasing and
			the chasers won’t be going after you, nor will they be able to catch you. It is, however, in
			your team’s interest to get as far away from them as possible during the first 15 minutes of
			the game.
		</li>
		<li>
		...
		<li>
			...
			<ul>
				<li>
					Because it is not fair to exit the bounds of the game to hide from the chaser, teams will
					have 1 point deducted for each violation detected.
				</li>
			</ul>
		</li>
		<li>
			...
			You may not purchase access to a venue that requires paid ticketed admission or is otherwise de
			facto unreachable by a chaser.
			<ul>
				<li>
		...
		<li>
			Each team is required to take a 10 minute food/bio break sometime between the beginning of the
			2nd hour and end of the 3rd hour. You are encouraged to do so only when you are safely far
			away from the chasers, or if you are in a safe zone. Failure to do so will result in
			disqualification.
		</li>
		<li>
	...
	<ul>
		<li>
			...
			may alternate feet every 30 seconds. They may be (and probably should be) assisted by at least
			one, if not two, other team members.
		</li>
	</ul>
	...
	<ul>
		...
		<li>
			...
			<ul>
				...
				<li>
					<strong>Distractions and diversions.</strong> Much like the D&Ds in RuneScape, these are side
					quests and can be done at any point in the game.
				</li>
			</ul>
		</li>
		...
		<li>
			...
			result in you not earning the points if your actions don’t qualify as properly completing the
			task.
		</li>
		<li>
	...
	<ul>
		<li>
			Teams must arrive at the pit stop by the designated end time of the game, as determined by the
			organizers. If they do not arrive at the pit stop on time, a points penalty will be assessed
			based on the following rules:
			<ul>
				<li>Being late will result in a deduction of 5 points</li>
				<li>
					For every minute a team is late, an additional 1 point will be deducted from their overall
					score
				</li>
			</ul>
		</li>
...
<details>
	...
	<p>Boundaries will be announced at a later date.</p>
</details>
...
<details>
	...
	<p>
		...
		participants will have the opportunity to ask clarifying questions to the organizers before the
		game starts. You will also have the chance to meet your team and discuss basic strategy. The
		game will begin when everyone is present and the organizers announce the start. Take your time
	...
	<p>
		...
		responsible for communicating with the organizers. In addition, one member of the team (who may
		also be the primary representative) must share their location with the chasers. They will then
		be able to see the chasers’ locations too.
	</p>
</details>
...
<details>
	...
	<p>
		The ending point will be a shop in Pike Place Market, to be announced on Signal one hour before
		the end of the game. The zone demarcating where the game could end is marked on the above map.
	</p>
</details>
...
<details>
	...
	<ol>
		...
		<li>
			Pick a representative for the team, who will be able to see the chasers’ locations (and whose
			location will be shared with the chasers)
		</li>
...
<blockquote class="disclaimer">
	...
	<p>
		You (a Participant) and your safety are of paramount importance during your participation in the
		Seattle Transit Trek (the “Game”). You are strongly advised to avoid areas that may present
		imminent danger to you or your fellow Participants. In case a diversion needs to be made, you
		should report it to the Organizers and appropriate compensation in terms of points and/or time
		will be made for you, including but not limited to, bonus points, the waiver of a late return
		penalty, etc.
	</p>
	<p>
	...
	<p>
		<strong>
			IN NO EVENT WILL THE ORGANIZERS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT,
			CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR
			PARTICIPATION IN THIS GAME, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
			BY PARTICIPATING IN THIS GAME, YOU HEREBY WAIVE, RELEASE, AND DISCHARGE THE ORGANIZERS AND
			THEIR AGENTS OF ANY AND ALL LIABILITY OR DAMAGES OF ANY KIND RELATED TO, ARISING FROM, OR IN
			ANY WAY CONNECTED WITH, YOUR PARTICIPATION IN THIS GAME, INCLUDING THOSE ALLEGEDLY ATTRIBUTED
			TO THE NEGLIGENT ACTS OR OMISSIONS OF THE AFOREMENTIONED PARTIES.
		</strong>
	</p>
</blockquote>
