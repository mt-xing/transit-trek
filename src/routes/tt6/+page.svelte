...
<div id="outerWrap">
	...
	<div class="cardWrap left">
		...
		<div class="textWrap">
			<Tt6Card>
				...
				spent by the unsuspecting travellers making the trip, and countless Transit Treks were
				played with only one side of the board.
			</Tt6Card>
		</div>
	</div>
	...
	<div class="cardWrap right">
		...
		<div class="textWrap">
			<Tt6Card>
				...
				futuristic transport, consistent in speed, frequent in time, and grade separated from
				traffic, linked the two disparate worlds. Finally, people could travel easily in these
				smooth new vehicles that the engineers called "trains."
			</Tt6Card>
		</div>
	</div>

	<div class="standardCardWrap" style="margin-bottom: 15vh;">
		<Tt6Card>
			...
			Crossover is a Transit Trek that spans both Seattle and the Eastside! Aided by the newly
			opened Link connections, ride transit and complete challenges across both sides of Lake
			Washington as you compete with other teams to see who can earn the most points, no longer
			burdeoned by the limits of geography.
		</Tt6Card>
	</div>
	...
	<div class="rulesCardWrap">
		<Tt6Card fillWidth={true}>
			<details>
				...
				<ul>
					<li>
						ORCA card with either a pass or at least $20 loaded on it<br />
					...
					<li>
						...
						<ul>
							...
							<li>
								A $5.50 participation fee. In return, you will be given a bandana to be used
								throughout the game (and to keep as a souvenir and for future Transit Treks!)
							</li>
							<li>
								Roughly 24-48 hours before the event begins, the participation fee may be raised to
								be higher than $5.50 because of the increased work we have to do to arrange teams
	...
	<div class="rulesCardWrap">
		<Tt6Card fillWidth={true}>
			<details>
				...
				<p>
					For more general information about all Transit Treks, please see:
		...
		<Tt6Card fillWidth={true} iosHack={isIPhone}>
			<details>
				...
				<ul>
					...
					<li>
						Every player (that’s you!; also known as a Transit Trekker) must have a fully charged
						mobile phone with Signal installed.
						<ul>
					...
					<li>
						For tracking purposes, one team member needs to share their location with the organizers
						on Find My (formerly known as Find My Friends).
					</li>
					<li>
						Players must travel by foot or public transit operated by the City of Seattle, the
						Seattle Monorail, King County Metro, or branded as Sound Transit.
						<ul>
							<li>
					...
					<li>
						Each team is required to take a 10 minute food/bio break sometime between the beginning
						of the 2nd hour and end of the 3rd hour. Failure to do so will result in
						disqualification.
					</li>
					<li>
						In case a bio break takes longer than 10 minutes, please inform the organizers so they
						can keep track of your team’s situation. Health and safety always come first, but it’s
						important for the organizers to keep track of exceptional circumstances affecting
						gameplay.
					</li>
				</ul>
				...
				<ul>
					...
					<li>
						...
						<ul>
							...
							<li>
								<strong>Find This.</strong> Within the game area, try to find where a given picture was
								taken.
							</li>
						</ul>
					</li>
					...
					<li>
						To officially complete a task, they must be reported to the organizers via Signal as
						...
						<ul>
							...
							<li>
								...
								the organizers will not inform the team of what they did incorrectly, and the team
								may try to repeat the task at most two more times. After that, they cannot continue
								attempting to complete the task and must try another task.
							</li>
						</ul>
					</li>
					...
					<li>
						If a task requires pictures as proof (which almost all of them do), all team members
						must be in the picture (as a selfie) unless explicitly not required. When in doubt, ask
						the organizers.
					</li>
					<li>
						If a task says you can’t look something up, it means you also can’t ask a
						non-participating person to look it up for you or tell you the answer.
					</li>
					<li>
						If you are not sure about what counts for a task, ask the organizers. Failure to ask may
						result in you not earning the points if your actions don’t qualify as properly
						completing the task.
					</li>
					<li>
						If a task requires each team member to procure something, then teams which have more
						members than other teams only need to get the number of items equivalent to the smallest
						team’s size. For instance, if the smallest team size is 4, then teams of 5 will only
						need to get 4 items.
					</li>
					<li>
						When completing tasks, please do not do anything that might lead to danger.
						<strong>Safety first.</strong>
						If you are concerned that you or other teams completing a task may result in harm, please
						contact the organizers immediately. They may issue a notice to everyone that a certain task
						is removed from the game due to safety concerns.
					</li>
					<li>
						<strong>
				...
				<ul>
					<li>
						Teams may not have any intentional contact with each other during the game, unless they
						see each other in person, or as otherwise specified in the rules.
					</li>
				</ul>
				...
				<ul>
					<li>
						Teams must arrive at the pit stop by the designated end time of the game, as determined
						by the organizers. If they do not arrive at the pit stop on time, a points penalty will
						be assessed based on the following rules:
						<ul>
					...
					<li>
						...
						<ul>
							<li>
								The amount of rules broken will be the first to break ties, with fewer rule
								violations giving higher priority
							</li>
							<li>
								Next, a team who successfully completed more challenges will be given higher
								priority
							</li>
							<li>
								All else failing, then it’s a fight to the death with rock paper scissors, best out
								of 3.
							</li>
						</ul>
					</li>
				...
				<ul>
					<li>
						You must obey all applicable laws, regulations, and rules during the game. (To be fair,
						it's probably also smart to obey laws outside the game.). <strong
							>This includes jaywalking.</strong
						>
					</li>
					<li>
						You must correctly pay the fare when taking transit. Note you no longer need to tap off
						of the Link.
					</li>
					<li>
						You may not obstruct any transit from operating along its normal schedule (by, for
						example, holding the doors open as they're closing).
					</li>
					<li>
						You may be filmed during the game for future promotional purposes unless you explicitly
						ask us not to film you.
					</li>
					<li>
						Rules can be changed by the organizers at any time before, during, and after the
						competition period. Whatever the organizers say can override any of the written rules.
						Rule changes will be clearly broadcasted on the Signal group.
					</li>
				</ul>
			</details>
		</Tt6Card>
	...
	<div class="rulesCardWrap">
		<Tt6Card fillWidth={true}>
			<details>
				...
				<p>
					Show up to Mercer Island Station <strong>by 1:00pm</strong>. Free parking is available at
					the station's parking lot. Alternatively, you can park for free at the South Bellevue Park
					& Ride (or any park and ride, really) and take the Link to Mercer Island. The rules will
					be explained and participants will have the opportunity to ask clarifying questions to the
					organizers before the game starts. You will also have the chance to meet your team and
					discuss basic strategy. The game will begin when everyone is present and the organizers
					announce the start. Take your time or hurry up. The choice is yours;
					<strong>don’t be late!</strong>
				</p>
				<p>
					One member of your team should be designated as the primary representative, who will be
					responsible for communicating with the organizers. In addition, one member of the team
					(who may also be the primary representative) must share their location with the
					organizers.
				</p>
			</details>
		</Tt6Card>
	...
	<div class="standardCardWrap">
		<Tt6Card color="red">
			<div class="disclaimer">
				...
				<p>
					You (a Participant) and your safety are of paramount importance during your participation
					in the Seattle Transit Trek (the “Game”). You are strongly advised to avoid areas that may
					present imminent danger to you or your fellow Participants. In case a diversion needs to
					be made, you should report it to the Organizers and appropriate compensation in terms of
					points and/or time will be made for you, including but not limited to, bonus points, the
					waiver of a late return penalty, etc.
				</p>
				<p>
				...
				<p>
					By participating in the Game, you agree that you are playing the Game at your own risk.
					You furthermore agree to hold the Organizers harmless and hold your fellow Participants
				...
				<p>
					<strong>
						...
						FROM YOUR PARTICIPATION IN THIS GAME, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF
						SUCH DAMAGES. BY PARTICIPATING IN THIS GAME, YOU HEREBY WAIVE, RELEASE, AND DISCHARGE
						THE ORGANIZERS AND THEIR AGENTS OF ANY AND ALL LIABILITY OR DAMAGES OF ANY KIND RELATED
						TO, ARISING FROM, OR IN ANY WAY CONNECTED WITH, YOUR PARTICIPATION IN THIS GAME,
	...
	<div class="standardCardWrap" style="margin-bottom: 5vh;">
		<Tt6Card>
			...
			<ul style="text-align: left;">
				<li>
					...
					Transit Trek 6 editor, Transit Trek co-organizer
				</li>
				<li>
