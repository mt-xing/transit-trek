export function copyGreeting(teamSecretGuid: string, teamNum: number) {
	const text =
		`Hi y'all! I'm Michael, and I'll be running Game Control today. Please ping me when you complete challenges so I can check off your progress. You can also ask me questions and I'll try my best to answer or direct you to someone who can.
