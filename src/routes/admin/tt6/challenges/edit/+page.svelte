...
<form method="POST">
	...
	<p>
		...
		<select bind:value={category} name="category">
			{#each iterateTt6Categories(tt6ChallengeCategoryNames) as categoryName}
				<option value={categoryName}>{tt6ChallengeCategoryNames[categoryName]}</option>
			{/each}
		</select>
	</p>
...
<div>
	...
	<form action="/admin/tt6/challenges/edit/deleteDanger" method="POST">
