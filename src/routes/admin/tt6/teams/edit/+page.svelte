...
<a href="/admin/tt6/teams">Discard and Return</a>
...
<div>
	...
	<form action="/admin/tt6/teams/edit/rotateSecret" method="POST">
...
<div style="background: red; margin-top: 100px; color: white;">
	...
	<form action="/admin/tt6/teams/edit/deleteDanger" method="POST">
		<input type="hidden" value={id} name="id" />
