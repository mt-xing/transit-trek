<script lang="ts">
	...
	import Tt4ChallengeView from './tt4ChallengeView.svelte';

	export let teamId: string;
	export let challenge: TT4ChallengeDefinition;
...
{#if progress}
	<div class="secWrap" style="background: black;">
		{#key challenge.id}
			<Tt4ChallengeView isFloat={false} {challengeProgress} {challenge} closeCallback={() => {}} />
		{/key}
	</div>
